...
interface HyperspeedProps {
  ...
  activePreset?: keyof typeof hyperspeedPresets;
}
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {}, activePreset = "five" }) => {
  const presetOptions = activePreset ? hyperspeedPresets[activePreset] : {};
